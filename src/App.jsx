    ...
    <div className='p-0  flex flex-col'>
      ...
      <div className='flex flex-col w-full h-auto my-8 gap-8 lg:flex-row '>
        ...
        <div className=' h-[50vh] w-[90vw] mx-auto lg:h-[60vh] lg:w-[40%] flex relative justify-center  gap-[2px] items-end'>
          <div className='w-[170px] h-[150px] bg-[#3a5987] rounded-l-[20px] flex flex-col justify-center items-center'>
            <div className='w-[100px] h-[100px] bg-[#989999] rounded-full absolute -translate-y-[80px]'>
              <img src="https://soorajsunil1409.github.io/Week-3-Codechef/assets/Jackson-C5VKmWYc.png" alt="" />
            </div>
            <div className='absolute flex justify-center size-[30px] -translate-y-9 lg:-translate-y-9'>
          ...
          <div className='w-[200px] h-[250px] bg-[#3a5987] rounded-t-[50px] gap-7 flex flex-col justify-center items-center'>
            <div className='size-[70px] translate-y-[-160px]'>
            ...
            <div className='w-[125px] h-[125px] bg-orange-300 rounded-full absolute -translate-y-[140px]'>
              <img src="https://soorajsunil1409.github.io/Week-3-Codechef/assets/Eiden-Cy55FkjG.png" alt="" />
            </div>
            <div className='absolute flex justify-center size-[30px] -translate-y-20 lg:-translate-y-20'>
            ...
            <div className='mb-24 gap-4 flex flex-col items-center'>
          ...
          <div className='w-[170px] h-[150px] bg-[#3a5987] rounded-r-[20px] relative flex flex-col justify-center items-center'>
